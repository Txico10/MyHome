...
<body>
    ...
    <div class="container">
        <table class="table table-borderless">
            <tr>
                <td>
                    <strong>Lease: </strong>{{'BL'.$lease->start_at->format('mY').$lease->id.$company->id}} <br>
                    <strong>Created at: </strong>{{$lease->created_at->format('d-F-Y h:i:s A')}} <br>
                    <strong>Created by:</strong>
                </td>
            </tr>
            <tr>
                <td class="bg-primary" style="text-align: center">FORMULAIRE OBLIGATOIRE DE LA RÉGIE DU LOGEMENT | EN DOUBLE EXEMPLAIRE</td>
            </tr>
            <tr>
                <table style="width: 100%;">
                    <tbody>
                        <tr>
                            ...
                            <td class="bg-primary" style="padding-left: 5px; width: 33.5%; ">ENTRE LE LOCATEUR</td>
                            <td class="bg-primary" style="padding-left: 5px;">ET LE LOCATAIRE</td>
                        </tr>
                    </tbody>
                </table>
            </tr>
            <tr>
                <td>
                    <div class="row">
                        <div class="col-xs-4" style="border-right:thin solid black;">
                            ...
                            P:{{$company->contacts->where('type', 'phone')->first()?$company->contacts->where('type', 'phone')->first()->description:""}} <br>
                            E: {{$company->contacts->where('type', 'email')->first()->description}}<br>
                        </div>
                        ...
                        <div class="col-xs-4">
                            ...
                            P:{{$user->contacts->where('type', 'mobile')->first()?$user->contacts->where('type', 'mobile')->first()->description:""}} <br>
                            E: {{$user->contacts->where('type', 'email')->first()->description}}<br>
                        </div>
                        @endforeach
                    </div>
                </td>
                ...
                <table style="width: 100%;">
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 1px;">&nbsp;</td>
                            <td class="bg-primary" style="padding-left: 5px">DESCRIPTION AND DESTINATION OF LEASED DWELLING, ACCESSORIES AND DEPENDENCIES</td>
                        </tr>
                    </tbody>
                </table>
            </tr>
            <tr>
                <td>
                    ...
                    <p>Furniture is included: <strong>{{$lease->furniture_included?"Yes":"No"}}</strong></p>
                    ...
                    <div style="border:thin solid; border-color:black; margin:2pt ;text-align: justify;">
                        <p style="padding: 1rem"><strong>The lessor and the lessee undertake, in acordance with their respective responsabilities, to comply with the regulations respecting the presence and proper working order of one or more smoke deterctor in the dweeling and the immovable.</strong></p>
                        <table class="signature_table">

                            <tr>
                              <td>WITNESS:</td>
                              <td class="written_field" style="width: 38%">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; padding-top: 0em;">
                                    Signature of lessor</td>
                                <td style="padding-top: 0em">&nbsp;</td>
                                <td style="text-align: center; padding-top: 0em;">
                                        Singature of lessee</td>
                            </tr>
                        </table>
                    </div>
                </td>
