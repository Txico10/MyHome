        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <select name="address_type" id="address_type" class="form-control" wire:model="address_type" data-placeholder="Enter address type" data-allow-clear="true" style="width: 85%" {{strcmp($address_type,'primary')==0 ? 'disabled':''}}>
                        <option value=""></option>
