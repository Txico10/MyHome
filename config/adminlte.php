...
return [
    ...
    */
    ...
    'filters' => [
        ...
        App\MenuFilter\MenuFilter::class,
    ],
        ...
        'Summernote' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/summernote/plugin/summernote-list-styles/summernote-list-styles-bs4.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/summernote/plugin/summernote-list-styles/summernote-list-styles-bs4.js',
                ],
            ],
        ],
        'Datepicker' => [
